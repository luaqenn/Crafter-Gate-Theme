...
export default function McWidget({ status }: { status: any }) {
  return (
    <Card className="bg-card/95 backdrop-blur-md border border-border/20 py-5 shadow-2xl hover:shadow-3xl transition-all duration-500 rounded-3xl w-full max-w-sm group cursor-pointer hover:scale-105 hover:-translate-y-1 relative">
